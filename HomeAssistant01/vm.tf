...
# __generated__ by Terraform from "pve01/vm/400"
resource "proxmox_vm_qemu" "HomeAssistant01" {
  ...
  smbios {
    ...
    serial       = null
    sku          = null
    uuid         = "86e2d209-405e-4057-878a-a37242d50525"
    version      = null
  }
}
